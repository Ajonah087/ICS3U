...
public class MathPlus {
	...
	private static int minArray (int [] arrayMin) {
		int minIndices=arrayMin[0];
		for (int i=0; i<arrayMin.length; i++) {
			if (arrayMin[i]>minIndices){
				minIndices=i;
			}
	...
	private static double minArray (double [] arrayMin) {
		...
		private static long minArray (long [] arrayMin) {
			int minIndices=0;
			for (int i=0; i<arrayMin.length; i++) {
				if (arrayMin[i]<arrayMin[minIndices]){
						minIndices=i;
			...
			//	private static int factoring(int factorNumber) {
			//		int compare = 0;
			//		int factor= 0;
			//		double valueFactor;
