...
public class Goldilocks {
 ...
 public static void main(String[] args) {
  ...
  else if (bowl2 > bowl1 && bowl1 > bowl3 || bowl2 < bowl1 && bowl3 > bowl1) System.out.println("Mama bear's bowl is " + bowl1); 
  
  else if (bowl2 > bowl3 && bowl3 > bowl1 || bowl2 < bowl3 && bowl3 < bowl1)System.out.println("Mama bear's bowl is, " + bowl3); 
